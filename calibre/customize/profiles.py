...
class WaveshareEinkLarge(GenericEink):

    author      = 'Mark Hartigan'
    name        = 'Waveshare e-ink large'
    short_name  = 'waveshare_eink_large'
    description = _('This profile is intended for the Waveshare 7.5" e-ink display.')
...
output_profiles = [
    ...
    WaveshareEinkLarge, KindleFireOutput, KindlePaperWhiteOutput, KindleVoyageOutput,
